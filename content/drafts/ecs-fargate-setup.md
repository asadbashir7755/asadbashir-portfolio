...
# ECS Fargate Production Setup: What I Actually Did

At CyberoidTech I worked on setting up a real ECS Fargate production environment for a client project called **ClubSoft**. This is not a tutorial, this is what I actually configured, the issues I ran into, and how I fixed them.
